...
<head>
    ...
    <title>Pondok Pesantren Al-Mu'minien</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="modal fade bs-example-modal-lg" id="essai" tabindex="-1" role="dialog"
                ...
                <form method='POST'
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <textarea rows='6' name='a' class="textarea form-control"
