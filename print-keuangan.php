...
<table border=0 width=100%>
  <tr>
    ...
    <td width="520"align="center">Mengetahui <br> Bendahara Pondok Pesantren Al-Mu'minien</td>
    <td width="260" align="left">Lohbener, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Wali Kelas</td>
  </tr>
  <tr>
