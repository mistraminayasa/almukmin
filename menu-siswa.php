<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="index.php?view=penilaiantemansiswa"><i class="fa fa-list"></i> <span>Penilaian Teman</span></a>
        </li>
        <li><a href="index.php?view=bahantugas&act=listbahantugassiswa"><i class="fa fa-file"></i><span>Bahan dan
                    Tugas</span></a></li>
        <li><a href="index.php?view=soal&act=detailsiswa"><i class="fa fa-users"></i><span>Quiz/Ujian Online</span></a>
        </li>
        <li><a href="index.php?view=forum&act=detailsiswa"><i class="fa fa-th-list"></i> <span>Forum Diskusi</span></a>
        </li>
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=raport&act=detailsiswa"><i class="fa fa-circle-o"></i> Data Nilai Raport</a>
                </li>
            </ul>
        </li>
    </ul>
