...
<head>
    ...
    <title>Pondok Pesantren Al-Mu'minin | Log in</title>
...
<body class="hold-transition login-page">
    ...
    <div class="login-logo">
            <a href="../sisfo/index.php"><b>SISFO</b> AKADEMIK</a>
            <h3><strong>Pondok Pesantren Al-Mu'minin</strong> </h3>
            <h4>Lohbener-Indramayu-Jawa Barat</h4> 
        </div><!-- /.login-logo -->
...
if (isset($_POST[login])){
 ...
 $siswa = mysql_query("SELECT * FROM rb_siswa WHERE nipd='".anti_injection($_POST[a])."' AND password='$passlain'");
